...
function validateform()
	{ 	
		...
		if((oldpass==null || oldpass=="")||(oldpass.length<8 ||oldpass.length>20)||(newpass.length<8 || newpass.length>20)|| !newpass.match(vpass) || newpass!=connewpass )
		{
			if (oldpass==null || oldpass=="" ) 
			 {
       			document.getElementById("soldpass").innerHTML="Please enter Old Password";
       			document.getElementById("soldpass").style.color = "red";
       			document.getElementById("soldpass").style.display = "block"; 
       		 }	
       		
        	 if(oldpass.length<8 ||oldpass.length>20)
        	 {
        	 	
				document.getElementById("soldpass").innerHTML="Password length should be of 8-20 characters";  
				document.getElementById("soldpass").style.color = "red";
    			document.getElementById("soldpass").style.display = "block"; 
        	 }
        	  else
       		 {
       		  	document.getElementById("soldpass").innerHTML = ""; 
          	    document.getElementById("soldpass").style.display = "none";
        	 }
...
<form name="changepass" action="ChangePasswordServ" method="post" onsubmit="return validateform()">
...
<center><table align="center">
	<tr>
		...
		<td><input type="password" name="oldpass" ><span id="soldpass"></td>
	</tr>
